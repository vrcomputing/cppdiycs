...
if __name__ == "__main__":
    ...
    struct_ids_for_files = castxml_util.get_struct_ids(
        root) if not args.source else castxml_util.get_struct_ids_for_files(root, args.source)
    # get all structs (and recursively required struct ids) fpr the requested types
    struct_ids_for_types = castxml_util.get_struct_ids(
        root) if not args.type else castxml_util.get_struct_ids_for_types(root, args.type)
